...
namespace System
{
	...
	public static class FishStringExtension
	{
		...
		public static int ToInt32(this string value, int defaultValue = 0, NumberStyles style = NumberStyles.None, IFormatProvider provider = null)
		{
			int temp;
		...
		/// <param name="value">字符串</param>
		/// <returns>转换后的 <see cref="System.Int32"/></returns>
		public static int? ToInt32Nullable(this string value, NumberStyles style = NumberStyles.None, IFormatProvider provider = null)
		{
			int temp;
		...
		public static int[] SplitAsIntArray(this string value, NumberStyles style = NumberStyles.None, IFormatProvider provider = null)
		{
		...
		public static long ToInt64(this string value, long defaultValue = 0, NumberStyles style = NumberStyles.None, IFormatProvider provider = null)
		{
			long temp;
		...
		/// <param name="value">字符串</param>
		/// <returns>转换后的 <see cref="System.Int64"/></returns>
		public static long? ToInt64Nullable(this string value, NumberStyles style = NumberStyles.None, IFormatProvider provider = null)
		{
			long temp;
		...
		public static float ToSingle(this string value, float defaultValue = 0.0F, NumberStyles style = NumberStyles.None, IFormatProvider provider = null)
		{
			float temp;
		...
		/// <param name="value">要转换的字符串</param>
		/// <returns>转换后的 <see cref="System.Single"/></returns>
		public static float? ToSingleNullable(this string value, NumberStyles style = NumberStyles.None, IFormatProvider provider = null)
		{
			float temp;
		...
		public static double ToDouble(this string value, double defaultValue = 0.0, NumberStyles styles = NumberStyles.None, IFormatProvider formatProvider = null)
		{
			double temp;
		...
		/// <param name="value">要转换的字符串</param>
		/// <returns>转换后的 <see cref="System.Double"/></returns>
		public static double? ToDoubleNullable(this string value, NumberStyles styles = NumberStyles.None, IFormatProvider formatProvider = null)
		{
			double temp;
		...
		/// <param name="defaultValue">如果转换失败,则返回的默认值</param>
		/// <returns>转换后的 <see cref="System.Double"/></returns>
		public static decimal ToDecimal(this string value, decimal defaultValue = 0m, NumberStyles styles = NumberStyles.None, IFormatProvider formatProvider = null)
		{
			decimal temp;
		...
		/// <param name="value">要转换的字符串</param>
		/// <returns>转换后的 <see cref="System.Double"/></returns>
		public static decimal? ToDecimalNullable(this string value, NumberStyles styles = NumberStyles.None, IFormatProvider formatProvider = null)
		{
			decimal temp;
